...
<body>
        ...
        <nav class="nav">
            ...
            <div class="end">
                <ul class="nav__links">
                    ...
                    <li class="nav__item">
                        <a class="nav__link nav__link--btn btn--show-account-modal" href="src/openAcc.php">Open Account</a>
                    </li>
    ...
    <section class="section section--sign-up">
        ...
        <button class="btn btn--show-modal" onClick="document.location.href='src/openAcc.php'">Open your free account today!</button>
    </section>
